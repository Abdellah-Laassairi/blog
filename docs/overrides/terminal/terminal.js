...
async function loadThemeConfig() {
    try {
        const response = await fetch('/blog/overrides/terminal/config/theme-config.yaml');
...
async function displayWelcome(terminal) {
    ...
    terminal.writeln('\x1b[1;32m│\x1b[0m  Welcome to Portfolio Terminal! 🚀          \x1b[1;32m│');
    terminal.writeln('\x1b[1;32m│\x1b[0m  Type "help" to see available commands     \x1b[1;32m│');
